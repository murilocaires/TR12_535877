...
/*Definição do tipo de funcao a ser utilizado para comparação
...
typedef struct heap{
	...
	COMP* comparador;//a funcao de comparação
}HEAP;

/**
Cria um heap vazio de tamanho n e com funcao de comparação compara
@param n: o tamanho do heap
@param compara: a funcao de comparação
...
/**
Adiciona o elemento newelem ao Heap, na posicao correta se for possí­vel
...
@param heap: o heap a ter o elemento incluí­do
